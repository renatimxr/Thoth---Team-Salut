...
class UsersRecord extends FirestoreRecord {
  ...
  bool hasUserPlan() => _userPlan != null;

  // "userCRM" field.
  String? _userCRM;
  String get userCRM => _userCRM ?? '';
  bool hasUserCRM() => _userCRM != null;

  // "userSpecialization" field.
  String? _userSpecialization;
  String get userSpecialization => _userSpecialization ?? '';
  bool hasUserSpecialization() => _userSpecialization != null;
  ...
  void _initializeFields() {
    ...
    _userPlan = snapshotData['userPlan'] as String?;
    _userCRM = snapshotData['userCRM'] as String?;
    _userSpecialization = snapshotData['userSpecialization'] as String?;
  }
...
class UsersRecordDocumentEquality implements Equality<UsersRecord> {
  ...
  bool equals(UsersRecord? e1, UsersRecord? e2) {
    ...
    return e1?.email == e2?.email &&
        ...
        e1?.userPlan == e2?.userPlan &&
        e1?.userCRM == e2?.userCRM &&
        e1?.userSpecialization == e2?.userSpecialization;
  }
