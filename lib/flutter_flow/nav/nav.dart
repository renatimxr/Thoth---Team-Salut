...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'EbooksPage',
          path: '/ebooksPage',
          builder: (context, params) => EbooksPageWidget(),
        ),
        FFRoute(
          name: 'VideosPage',
          path: '/videosPage',
        ...
        FFRoute(
          name: 'ArticlesPage',
          path: '/articlesPage',
          builder: (context, params) => ArticlesPageWidget(),
        ),
        FFRoute(
          name: 'TrailsPage',
          path: '/trailsPage',
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'TrailsPage')
              : TrailsPageWidget(),
        ),
        FFRoute(
          name: 'LearningPage',
        ...
        FFRoute(
          ...
          path: '/ebookReaderPage',
          builder: (context, params) => EbookReaderPageWidget(
        ...
        FFRoute(
          ...
          builder: (context, params) => ArticleDetailsWidget(
            ...
            articleCategory: params.getParam(
              'articleCategory',
              ParamType.String,
            ),
        ...
        FFRoute(
          name: 'EnterpreneurTrail',
          path: '/enterpreneurTrail',
          builder: (context, params) => EnterpreneurTrailWidget(),
        ),
        FFRoute(
