                            ...
                            context.pushNamed(
                              ...
                              queryParameters: {
                                'articleTitle': serializeParam(
                                  listViewArticlesRecord.articleTitle,
                                  ParamType.String,
                                ),
                                'articleImage': serializeParam(
                                  listViewArticlesRecord.articleCoverImage,
                                  ParamType.String,
                                ),
                                'articleCategory': serializeParam(
                                  listViewArticlesRecord.articleCategory,
                                  ParamType.String,
                                ),
                                'articleContent': serializeParam(
                                  listViewArticlesRecord.articleText,
                                  ParamType.String,
                                ),
                              }.withoutNulls,
                            );
